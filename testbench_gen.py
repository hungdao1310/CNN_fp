...
#            for k1 in range(kk):
#                for k2 in range(kk):
#                    s = float_to_fixed_point(weight_3d[i][j][k1][k2], 13, 3) + " "
#                    file.write(s)
#                file.write(f"\n")
#            file.write(f"\n")
#        file.write("\n")
...
#                    s = float_to_fixed_point(weight1_3d[i][j][k1][k2], 13, 3) + " "
#                    file.write(s)
#                file.write(f"\n")
#            file.write(f"\n")
#        file.write("\n")
...
#                    s = float_to_fixed_point(weight2_3d[i][j][k1][k2], 13, 3) + " "
#                    file.write(s)
#                file.write(f"\n")
#            file.write(f"\n")
#        file.write("\n")
...
#                    s = float_to_fixed_point(weight3_3d[i][j][k1][k2], 13, 3) + " "
#                    file.write(s)
#                file.write(f"\n")
#            file.write(f"\n")
#        file.write("\n")
...
#                    s = float_to_fixed_point(weight4_3d[i][j][k1][k2], 13, 3) + " "
#                    file.write(s)
#                file.write(f"\n")
#            file.write(f"\n")
#        file.write("\n")
...
#            for k in range(tile):
#                s = float_to_fixed_point(weight_fc1_3d[k+i*tile][j], 13, 3) + " "
#                file.write(s)
#            file.write(f"\n")
#        file.write(f"\n")
#
...
#            for k in range(tile):
#                s = float_to_fixed_point(weight_fc2_3d[k+i*tile][j], 13, 3) + " "
#                file.write(s)
#            file.write(f"\n")
#        file.write(f"\n")
#
...
#                s = float_to_fixed_point(weight_fc3_3d[k+i*tile_out][j], 13, 3) + " "
#                file.write(s)
#            file.write(f"\n")
#        file.write(f"\n")
#
...
with open("ofm.txt", "w") as file:
    for i in range(out_feature_3):
        s = float_to_fixed_point(ofm_3d[i], 13, 11) + " "
        file.write(s)
        file.write("\n")
